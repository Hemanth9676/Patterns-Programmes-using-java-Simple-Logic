...
public class HalloDaimands {
	...
	for (int i = (-num) + 1; i < num; i++) {
		...
		for (int j = (-num) + 1; j < num; j++) {
			...
			if (a == b)   // ---> "If you want "Cross-Diamond Pattern",' just replace a == b with a != b. The remaining code stays the same; do not change anything else."
				System.out.print("*" + " ");
